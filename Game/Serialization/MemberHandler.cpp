...
void BasicTypeHandler<MemberType>::Load(const pugi::xml_node* xmlNode, MemberType& memberType, const char* memberName, CStringID memberID)
{
...
template<class MemberType>
void BasicTypeHandler<MemberType>::Save(pugi::xml_node* xmlNode, MemberType& memberType, const char* memberName, CStringID memberID)
{
